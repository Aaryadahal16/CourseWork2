# This is pharamacy management system using Tkinter and FileHandling
# Copyright 2021-Aarya Dahal
# id - 210357
...
def additem():
    ...
    if entry1.get() == "" and entry2.get() == "" and entry3.get() == "" and entry4.get() == "" and entry5.get() == "" and entry6.get() == "":
        ...
        print("Error")
        tkMessageBox.showerror("error", "all information must be filled")
        ...
        try:
            if (result == "yes"):
                print("here")
                with open("CW2.csv", 'a') as csvfile: #file handling1
                    csvfile.write('{0}, {1}, {2}, {3},{4},{5}\n'.format(str(e_1), e_2, e_3, str(e_4), str(e_5), e_6))
            ...
            tkMessageBox.showinfo("Info","No information was added ")
...
def updateitem():
    ...
    if entry1.get() == "" and entry2.get() == "" and entry3.get() == "" and entry4.get() == "" and entry5.get() == "" and entry6.get() == "":
        ...
        print("Error")
        tkMessageBox.showerror("error", "sorry but there's some issue with this information..")
    else:
        result = tkMessageBox.askquestion("Submit",
        ...
        if (result == "yes"):
            print("here")
            with open("CW2.csv", "r") as f1, open("pharmacy1.csv", "w") as working:
                for line in f1:
...
def viewitem():
    ...
    with open('CW2.csv', "r") as f:
        ...
        for row in reader:
            ...
            tree.insert("", 0, values=(MedicineName, MedicinePrice, Quantity, Category, Description, Discount)) # use of list
    f.close()
    txt_result.config(text="Successfully read the data from CW2.csv file", fg="black")
...
Top = Frame(root, width=900, height=50, bd=8, relief="raised") # raised is one of the styles of relief
Top.pack(side=TOP)
